...
function recalculate() {
    let costLabel = 0;
    costLabel = document.getElementById("calculated-cost").innerHTML;
    if (modelName == "Model XYZ"){
        costLabel = duration * 100;
        return document.getElementById("calculated-cost").innerHTML = costLabel;
...
//modelButton.addEventListener("click", changeModel);//uncomment line
...
function changeModel(){
    ...
    if (modelName == "Model XYZ"){
        ...
        return document.getElementById("model-text").innerHTML = modelName;
    } else if (modelName == "Model CPRG"){
        modelName = "Model XYZ";
        return document.getElementById("model-text").innerHTML = modelName;
    }
...
// INSERT YOUR CODE HERE(done, not tested)
